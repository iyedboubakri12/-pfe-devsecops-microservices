(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/forms'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@rxweb/reactive-form-validators', ['exports', 'rxjs', 'rxjs/operators', '@angular/forms', '@angular/core', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.rxweb = global.rxweb || {}, global.rxweb["reactive-form-validators"] = {}), global.rxjs, global.rxjs.operators, global.ng.forms, global.ng.core, global.ng.common));
})(this, (function (exports, rxjs, operators, forms, core, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ObjectMaker = /** @class */ (function () {
        ...
        ObjectMaker.toJson = function (key, config, values, additional) {
            var _this = this;
        ...
        if (FormProvider.ProcessRule(control, config)) {
            if (RegexValidator.isNotBlank(control.value)) {
                if (isValid(control, config)) {
                    ...
                    var additionalValue = (_a = {}, _a[operationType == AnnotationTypes.minTime ? "min" : "max"] = crossControlValue, _a);
                    if (!isValid_1)
                    ...
                    switch (property.propertyType) {
                        case PROPERTY:
                            if (!(entityObject[property.name] instanceof forms.FormControl || entityObject[property.name] instanceof RxFormControl)) {
                                ...
                                formGroupObject[property.name] = new RxFormControl(sanitizeValue, abstractControlOptions_1, undefined, json.entityObject, Object.assign({}, json.entityObject), property.name, instanceContainer.sanitizers[property.name]);
                                _this.isNested = false;
                            }
                            else
    ...
    exports.AsyncValidationDirective = AsyncValidationDirective;
    exports.FileControlDirective = FileControlDirective;
    exports.FormBuilderConfiguration = FormBuilderConfiguration;
    exports.HtmlControlTemplateDirective = HtmlControlTemplateDirective;
    exports.IAbstractControl = IAbstractControl;
    exports.ImageFileControlDirective = ImageFileControlDirective;
    ...
    exports.RxFormControlDirective = RxFormControlDirective;
    exports.RxFormGroup = RxFormGroup;
    exports.RxReactiveFormsModule = RxReactiveFormsModule;
    exports.RxwebFormDirective = RxwebFormDirective;
    ...
    exports["ɵb"] = BaseValidator;
    exports["ɵc"] = ControlExpressionProcess;
    exports["ɵd"] = DecimalProvider;
    exports["ɵf"] = ControlHostDirective;
    exports["ɵg"] = BaseFormBuilder;
