...
export class StudentFormComponent implements OnInit {
  ...
  createStudent() {
    const file = this.file_store && this.file_store.length ? this.file_store[0] : null;
    this._studentService.createWithImage(this.addStudentForm.value, file).subscribe(res => {
  ...
  editStudent() {
    const file = this.file_store && this.file_store.length ? this.file_store[0] : null;
    this._studentService.editWithImage(this.addStudentForm.value, file).subscribe(res => {
